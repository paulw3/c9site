...
export const ui = {
  ...
  ar: {
    ...
    methodologyDesignCopy: 'بنية الحالة المستهدفة، ترسم قبل نقل أي حمل عمل واحد.',
    methodologyEngineerLabel: 'الهندسة',
    methodologyEngineerCopy: 'تنفيذ محكوم: مصنع ترحيل أو نشر GDC، أيا كانت الوجهة المطلوبة.',
    ...
    leadershipBioPending: 'السيرة الذاتية قريبا.',
    formName: 'الاسم',
    ...
    formLookingForUnsure: 'لست متأكدا بعد',
    formMessage: 'الرسالة',
    formSend: 'إرسال',
